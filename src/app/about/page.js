  ...
  return (
    <div>
      <div className={"mt-[40px] h-[400px] w-full rounded-xl md:h-[400px] md:w-[689px] lg:h-[450px] lg:w-[1280px]"}>
        ...
        {/*</picture>*/}
        <Image className={"rounded-xl md:hidden lg:hidden"} src={mobile} alt={"Hero Image"} priority={true} loading={"eager"} />
        <Image className={"hidden rounded-xl md:block lg:hidden"} src={tablet} alt={"Hero Image"} priority={true} loading={"eager"} />
        <Image className={"hidden rounded-xl lg:block"} src={desktop} alt={"Hero Image"} priority={true} loading={"eager"} />
      </div>
